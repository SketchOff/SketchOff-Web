...
export default function(io, socket) {
    ...
    socket.on('get all avaliable players', function() {
        ...
        GameRoomManager.ConnectedPlayers.forEach(function(val, key) {
            if (!val.in_game && !val.in_queue) {
                avaliablePlayers[key] = val;
            }
        });
    ...
    socket.on('get lobby info', function() {
        ...
        console.log(socket.request.user.username + 'is requesting lobby info to', GameRoom.getRoomID());
